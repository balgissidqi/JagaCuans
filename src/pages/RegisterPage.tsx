    ...
    try {
      const { data, error } = await supabase.auth.signUp({
        ...
        options: {
          ...
          emailRedirectTo: "https://jaga-cuans.vercel.app/verified",
        },
      });
      ...
      toast.success(
        "Registrasi berhasil! Silakan cek emailmu untuk verifikasi sebelum login.",
      );
      navigate("/login");
    } catch (error: any) {
    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, hsl(var(--income) / 0.1), hsl(var(--primary) / 0.1))",
          }}
        >
            ...
            <CardContent className="px-8 pb-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, hsl(var(--income)), hsl(var(--income) / 0.8))",
